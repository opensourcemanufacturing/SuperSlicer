...
std::string GCodeWriter::_travel_to_z(double z, const std::string &comment)
{
    ...
    */
    ...
    if(FLAVOR_IS(gcfopenfl)){ 
        ...
        //     gcode << "\n";
        //     gcode << "0x03 ZMove ";
            gcode << m_last_z = m_pos.z(); gcode << " , "; gcode << m_pos.z() = z; gcode << " , "; gcode << int(m_z_move - microsteps_5mm);
        ...
        //     gcode << "\n";
        //     return gcode.str();
            gcode << m_last_z = m_pos.z(); gcode << " , "; gcode << m_pos.z() = z; gcode << " , "; gcode << int(m_z_move); 
         }
